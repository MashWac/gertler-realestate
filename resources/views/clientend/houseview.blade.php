...
<div class="housepageview">
    <div class="producttitlemain">
        <h1 class="producttitlemaintext"> 4 Modern flat roof in Balozi</h1>
    </div>
        ...
        <ul class="listfeatures">
            <li>
                <div class="featureshouse">
                    ...
                    <p class="featureinfo"> KSH 7,500,000 </p>
                </div>
            </li>
            <li> 
                <div class="featureshouse">
                    <h3 class="featuretitle">Neighbourhood</h3>
                    <p class="featureinfo"> Muthaiga</p>
                </div>
            </li>
            <li>
                <div class="featureshouse">
                    <h3 class="featuretitle">Sqft</h3>
                    <p class="featureinfo">5000 sqft</p>
                </div>
            </li>
            <li>
                <div class="featureshouse">
                    <h3 class="featuretitle">Floor</h3>
                    <p class="featureinfo">4th</p>
                </div>
            </li>
            <li>
                <div class="featureshouse">
                    <h3 class="featuretitle">Total Rooms</h3>
                    <p class="featureinfo">10 Rooms</p>
                </div>
            </li>
            <li>
                <div class="featureshouse">
                    <h3 class="featuretitle">House Type</h3>
                    <p class="featureinfo">Condominium</p>
                </div>
            </li>
        </ul>
    </div>
    <div class="houseimagescarousel">
    <img src="/assets/staticimg/infinitypool1.jpg" alt="..." class="imageshouseview">
    ...
    <div class="reveal abouthousedetails">
        <div class="abouthousedetailstext">
            ...
            <p class="abouthousetitleparagraph">
                This item is connected to a text field in your content collection. 
                Double click what you want to edit and then select "Change Content" to add your own content to the collection. Want to view and manage all your collections? 
                Click the Content Manager icon on the add panel to your left. 
                In the Content Manager, you can update items, add new fields, create dynamic pages and more.
            </p>
        </div>
